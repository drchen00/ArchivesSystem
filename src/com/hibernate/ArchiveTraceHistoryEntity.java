 ...
 */
@Entity
@Table(name = "ArchiveTraceHistory", schema = "archivesSystem", catalog = "")
public class ArchiveTraceHistoryEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        ArchiveTraceHistoryEntity that = (ArchiveTraceHistoryEntity) o;
